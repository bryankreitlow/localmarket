...
var getMasterHash = require('../util/GetMasterHash');
var fallbackHash = "b39138c90c2f323b2ae6445ab7deee8ca23ce7f5";
...
module.exports = function(app, passport, auth) {
  ...
  getMasterHash(function(err, hash) {
    if(err) {
      sharedContext.CacheBusterString = fallbackHash;
    } else {
      sharedContext.CacheBusterString = hash;
    }
    //Configure Server
